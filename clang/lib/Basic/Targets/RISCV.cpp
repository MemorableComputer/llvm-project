...
static constexpr int NumRVVAndesBuiltins =
    RISCVVector::FirstMemorableBuiltin - RISCVVector::FirstAndesBuiltin;
static constexpr int NumRVVMemorableBuiltins =
    RISCVVector::FirstTSBuiltin - RISCVVector::FirstMemorableBuiltin;
...
static_assert(NumBuiltins ==
              (NumRVVBuiltins + NumRVVSiFiveBuiltins + NumRVVAndesBuiltins +
               NumRVVMemorableBuiltins + NumRISCVBuiltins));
...
namespace RVVMemorable {
#define GET_RISCVV_BUILTIN_STR_TABLE
#include "clang/Basic/riscv_memorable_builtins.inc"
#undef GET_RISCVV_BUILTIN_STR_TABLE

static constexpr std::array<Builtin::Info, NumRVVMemorableBuiltins> BuiltinInfos =
    {
#define GET_RISCVV_BUILTIN_INFOS
#include "clang/Basic/riscv_memorable_builtins.inc"
#undef GET_RISCVV_BUILTIN_INFOS
...
RISCVTargetInfo::getTargetBuiltins() const {
  return {
      ...
      {&RVVMemorable::BuiltinStrings, RVVMemorable::BuiltinInfos, "__builtin_rvv_"},
