...
; O2: call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv2f32.i64(
define void @quantize_store_only_global(<vscale x 2 x float> %v) {
  call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv2f32.i64(<vscale x 2 x float> %v, ptr @prob_region, ptr null, i64 16)
  ret void
}

; WALL: IR order store.int4 -> drain -> tile.load survives -O2 into
...
; ATTRS: declare void @llvm.riscv.memorable.int4.quantize.e8m0.nxv2f32.i64(<vscale x 2 x float>, ptr, ptr, i64) [[WRONLY:#[0-9]+]]
