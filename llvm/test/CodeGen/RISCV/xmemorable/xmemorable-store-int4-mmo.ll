...
; the ISS (model/vector/vector_engine.h, VectorEngine::StoreInt4)
...
define void @mmo_m1(<vscale x 2 x float> %v, ptr %data, ptr %scale) {
  call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv2f32.i64(<vscale x 2 x float> %v, ptr %data, ptr %scale, i64 16)
  ret void
}
declare void @llvm.riscv.memorable.int4.quantize.e8m0.nxv2f32.i64(<vscale x 2 x float>, ptr, ptr, i64)
; MIR-LABEL: name:{{ *}}mmo_m1
; MIR: PseudoXMV_STORE_INT4_E8M0_M1 {{.*}} :: (store (s64) into %ir.data
...
; MIR: PseudoXMV_STORE_INT4_E8M0_M2 {{.*}} :: (store (s128) into %ir.data

define void @mmo_m4(<vscale x 8 x float> %v, ptr %data, ptr %scale) {
  call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv8f32.i64(<vscale x 8 x float> %v, ptr %data, ptr %scale, i64 64)
  ret void
}
declare void @llvm.riscv.memorable.int4.quantize.e8m0.nxv8f32.i64(<vscale x 8 x float>, ptr, ptr, i64)
; MIR-LABEL: name:{{ *}}mmo_m4
; MIR: PseudoXMV_STORE_INT4_E8M0_M4 {{.*}} :: (store (s256) into %ir.data
; MIR-SAME: , align 8)

define void @mmo_m8(<vscale x 16 x float> %v, ptr %data, ptr %scale) {
  call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv16f32.i64(<vscale x 16 x float> %v, ptr %data, ptr %scale, i64 128)
  ret void
}
declare void @llvm.riscv.memorable.int4.quantize.e8m0.nxv16f32.i64(<vscale x 16 x float>, ptr, ptr, i64)
; MIR-LABEL: name:{{ *}}mmo_m8
; MIR: PseudoXMV_STORE_INT4_E8M0_M8 {{.*}} :: (store (s512) into %ir.data
; MIR-SAME: , align 8)
...
define <vscale x 8 x float> @load_hoists_above_store(<vscale x 8 x float> %v, ptr noalias %data, ptr addrspace(1) noalias %row, <vscale x 8 x float> %shift) {
  call void @llvm.riscv.memorable.int4.quantize.e8m0.nxv8f32.i64(<vscale x 8 x float> %v, ptr %data, ptr null, i64 64)
...
; REORDER-NOT: store.int4.e8m0
; REORDER: tile.load
; REORDER: store.int4.e8m0
